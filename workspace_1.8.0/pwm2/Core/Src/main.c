 ...
 void TIMER2_Init(void)
{
	 ...
	 HAL_TIM_PWM_ConfigChannel(&htimer2, &tim2PWM_config, TIM_CHANNEL_1);

	 tim2PWM_config.Pulse = (htimer2.Init.Period*45)/100;
	 HAL_TIM_PWM_ConfigChannel(&htimer2, &tim2PWM_config, TIM_CHANNEL_2);

	 tim2PWM_config.Pulse = (htimer2.Init.Period*75)/100;
	 HAL_TIM_PWM_ConfigChannel(&htimer2, &tim2PWM_config, TIM_CHANNEL_3);

	 tim2PWM_config.Pulse = (htimer2.Init.Period*25)/100;
	 HAL_TIM_PWM_ConfigChannel(&htimer2, &tim2PWM_config, TIM_CHANNEL_4);
